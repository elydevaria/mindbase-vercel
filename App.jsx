...
export default function MindBase() {
  ...
  return (
    <div style={{ display:"flex", height:"100vh", fontFamily:"system-ui,sans-serif", background:"#f5f3ee", overflow:"hidden", position:"relative" }}>
      ...
      {/* Sidebar */}
      <aside style={{ width:220, background:"#fff", borderRight:"1px solid #e2ddd5", display:"flex", flexDirection:"column", flexShrink:0, ...(isMobile ? { position:"fixed", top:0, left:0, height:"100vh", zIndex:450, transform: sidebarOpen ? "translateX(0)" : "translateX(-100%)", transition:"transform 0.25s ease", boxShadow: sidebarOpen ? "4px 0 20px rgba(0,0,0,0.15)" : "none" } : {}) }}>
      ...
      <div style={{ flex:1, display:"flex", flexDirection:"column", overflow:"hidden" }}>
        ...
        <div ref={chatRef} style={{ flex:1, overflowY:"auto", padding: isMobile ? "14px 14px 0" : "22px 24px 0", display:"flex", flexDirection:"column", gap:14 }}>
          {messages.length===0 && (
          ...
          {messages.map((msg,i)=>(
            <div key={i} style={{ display:"flex", gap:10, flexDirection:msg.type==="user"?"row-reverse":"row", alignItems:"flex-start" }}>
              ...
              <div style={{ maxWidth: isMobile ? "88%" : "78%" }}>
